...
class CompExtractorApp:
    def __init__(self, root):
        ...
        self.root.geometry("900x850")  # Increased height to ensure all elements are visible without scrolling
...
class AudioReflectionPage(ttk.Frame):
    def __init__(self, parent, controller):
        ...
        # Progress bar
        self.progress_bar = ttk.Progressbar(main_frame, length=600, mode='indeterminate')
    ...
    def start_analysis(self):
        ...
        if not os.path.exists('In the Zone.mp3'):
            messagebox.showerror("Error", "Required In the Zone.mp3 file not found")
            return
    ...
    def run_analysis(self):
        try:
            ...
            # Stop background music and show completion
            mixer.music.stop()
